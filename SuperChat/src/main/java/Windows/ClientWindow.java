...
public class ClientWindow extends JFrame{
    ...
    public ClientWindow() {
        ...
        all.setLayout(null);
        all.setToolTipText("Общий чат всех пользователей");
        ...
        chat.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED, new Color(215, 253, 227),
                new Color(177, 224, 195)));
        scrollChat.setBounds(5,5, 350, 478);
        scrollChat.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED, new Color(198, 219, 241),
                new Color(173, 192, 211)));
        ...
        users.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED, new Color(215, 253, 227),
                new Color(177, 224, 195)));
        users.setToolTipText("Нажмите для отправки ЛС");
        scrollUsers.setBounds(360,5,105, 513);
        scrollUsers.setBackground(new Color(237, 240, 238));
        scrollUsers.setFont(fontText);
        scrollUsers.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED, new Color(198, 219, 241),
                new Color(173, 192, 211)));

        messageText = new JTextField("/войти ");
        messageText.setToolTipText("Введите логин и пароль через пробел");
        ...
        messageText.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED, new Color(198, 219, 241),
                new Color(173, 192, 211)));
        ...
        sendButton.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(198, 219, 241),
                new Color(173, 192, 211)));
    ...
    public void createNewPanel(String userName, String message){
        ...
        privateChatArea.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED,
                new Color(215, 253, 227), new Color(177, 224, 195)));
        scrollPrivateChatArea.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED,
                new Color(198, 219, 241), new Color(173, 192, 211)));
        privateMessageText.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED,
                new Color(198, 219, 241), new Color(173, 192, 211)));
        ...
        privateSendButton.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED,
                new Color(198, 219, 241), new Color(173, 192, 211)));
    }
}
